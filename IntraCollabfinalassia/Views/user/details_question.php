...
?>
  ...
  <?php if($questions['UTILISATEUR_ID'] == $_SESSION['user_id']):?>
                    ...
                    <?php  elseif ($questions['ETAT_ID'] != 5):?>
                        <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li class="dropdown-header">
...
<form action="..\..\controllers\user\ajouter_reponseAction.php" method="POST" id="reponseForm">
        ...
        <div class="img-push">
            ...
            <div>
            <textarea class="form-control" rows="5" name="reponsee" id="reponsee">Ajouter une reponse ...</textarea>
            </div>
            ...
            <div style="display:none;" id="reponse_container">
                ...
                <div class="timeline-body"  style="padding-bottom:0">
                    ...
                    <div class="timeline-footer">
                        <a href="javascript:;" class="m-r-15 text-inverse-lighter like-button" data-id=""><i class="fa fa-thumbs-down fa-fw fa-lg m-r-3"></i> <?php echo $reponse["NB_DISLIKE"]; ?></a>
                        <a href="javascript:;" class="m-r-15 text-inverse-lighter like-button" data-id=""><i class="fa fa-thumbs-up fa-fw fa-lg m-r-3"></i><?php echo $reponse["NB_LIKE"]; ?></a>
